...
targets = [
    ...
    "novena-mexico.png",
    "Puerta_la_Victoria.png",
    "Hard_Rock_Cafe_Guadalajara.png",
    "Aeropuerto_de_Monterrey.png"
]
...
for filename in targets:
    ...
    # Simple binary search on the scale factor to hit exactly 80% file size (± 5%)
    with Image.open(path) as img:
        ...
        try:
            for _ in range(6): 
                ...
                # Check if we are within 2% margin
